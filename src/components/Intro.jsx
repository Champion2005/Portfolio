...
export const Intro = ({aboutRef, skillRef, projectRef}) => {
    ...
    return (
        <section id="leftMenu" className="justify-self-start mt-16 px-6 sm:flex min-w-full sm:min-w-2/5  text-primaryText">
            <div className="sm:min-w-3/4">
                ...
                <div className="flex md:flex-col justify-start gap-8 md:gap-0 mt-3">
                    <div className="flex flex-col gap-0">
                        <a href="https://github.com/Champion2005" target="none" className="text-md sm:text-lg text-secondaryText/60 hover:text-secondaryText underline">-{'>'} Github</a>
                    ...
                    <nav className="md:mt-8">
                        <ul className="flex flex-col gap-0 text-md sm:text-lg">
                            <li>
                                <button onClick={() => {aboutRef.current?.scrollIntoView({behavior: 'smooth'})}} className="text-secondaryText/60 hover:text-secondaryText">-{'>'} About</button>
                            </li>
                            <li>
                                <button onClick={() => {skillRef.current?.scrollIntoView({behavior: 'smooth'})}} className="text-secondaryText/60 hover:text-secondaryText">-{'>'} Skills</button>
                            </li>
                            <li>
                                <button onClick={() => {projectRef.current?.scrollIntoView({behavior: 'smooth'})}} className="text-secondaryText/60 hover:text-secondaryText">-{'>'} Projects</button>
                            </li>
                        </ul>
                    </nav>
                </div>
